...
<div id="banner-area" class="banner-area" style="background-image:url('{{url('assets/images/banner/banner1.jpg')}}')">
  ...
  <section id="main-container" class="main-container">
    <div class="container">
      <div class="row">
          <div class="col-lg-6">
            <h3 class="column-title">Nous sommes</h3>
            <p> UNE SARL</p></blockquote>
            <p>qui fait dans le change de devise a travers le monde </p>
            <blockquote><p>
                en effet nous envoyons de l'argent partout dans le monde
        </p>
          ...
          <div class="col-lg-12">
            <div id="team-slide" class="team-slide">
                <div class="item">
                  <div class="ts-team-wrapper">
                      <div class="team-img-wrapper">
                        <img loading="lazy" class="w-100" src="{{url('assets/images/team/team1.jpg')}}" alt="team-img">
                      </div>
                ...
                <div class="item">
                  <div class="ts-team-wrapper">
                      <div class="team-img-wrapper">
                        <img loading="lazy" class="w-100" src="{{url('assets/images/team/team2.jpg')}}" alt="team-img">
                      </div>
                      <div class="ts-team-content">
                ...
                <div class="item">
                  <div class="ts-team-wrapper">
                      <div class="team-img-wrapper">
                        <img loading="lazy" class="w-100" src="{{url('assets/images/team/team3.jpg')}}" alt="team-img">
                      </div>
                      <div class="ts-team-content">
                ...
                <div class="item">
                  <div class="ts-team-wrapper">
                      <div class="team-img-wrapper">
                        <img loading="lazy" class="w-100" src="{{url('assets/images/team/team4.jpg')}}" alt="team-img">
                      </div>
                      <div class="ts-team-content">
                ...
                <div class="item">
                  <div class="ts-team-wrapper">
                      <div class="team-img-wrapper">
                        <img loading="lazy" class="w-100" src="{{url('assets/images/team/team5.jpg')}}" alt="team-img">
                      </div>
                      <div class="ts-team-content">
                ...
                <div class="item">
                  <div class="ts-team-wrapper">
                      <div class="team-img-wrapper">
                        <img loading="lazy" class="w-100" src="{{url('assets/images/team/team6.jpg')}}" alt="team-img">
                      </div>
                      <div class="ts-team-content">
